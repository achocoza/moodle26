...
echo $OUTPUT->box_start('generalbox boxaligncenter boxwidthwide', 'intro'); // RT - added #intro for styles
...
if (!$questionnaire->is_active()) {
    ...
    if ($questionnaire->questions) { // Sanity check.
        ...
        'id='.$questionnaire->cm->id).'" class="questionnairego">'.$complete.'</a>'; // RT - added class for styles
    }
}
if (!$questionnaire->questions) {
